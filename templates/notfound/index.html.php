...
<div class="bg-white">
        ...
        <ul role="list" class="mt-4 border-t border-b border-gray-200 divide-y divide-gray-200">
          <li class="relative py-6 flex items-start space-x-4">
            ...
            <div class="min-w-0 flex-1">
              ...
              <p class="text-base text-gray-500">Learn how to integrate our tools with your app</p>
            </div>
          ...
          <li class="relative py-6 flex items-start space-x-4">
            ...
            <div class="min-w-0 flex-1">
              ...
              <p class="text-base text-gray-500">A complete API reference for our libraries</p>
            </div>
            <div class="flex-shrink-0 self-center">
              <!-- Heroicon name: solid/chevron-right -->
              <svg class="h-5 w-5 text-gray-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
          ...
          <li class="relative py-6 flex items-start space-x-4">
            ...
            <div class="min-w-0 flex-1">
              ...
              <p class="text-base text-gray-500">Installation guides that cover popular setups</p>
            </div>
            <div class="flex-shrink-0 self-center">
              <!-- Heroicon name: solid/chevron-right -->
              <svg class="h-5 w-5 text-gray-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  <footer class="max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8">
    <div class="border-t border-gray-200 py-12 text-center md:flex md:justify-between">
      <p class="text-base text-gray-400">&copy; Workflow, Inc. All rights reserved.</p>
      <div class="mt-6 flex justify-center space-x-8 md:mt-0">
        <a href="#" class="inline-flex text-gray-400 hover:text-gray-500">
