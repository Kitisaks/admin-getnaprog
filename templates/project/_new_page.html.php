  ...
  <div class="bg-white py-6 px-4 space-y-6 sm:p-6">
    ...
    <div class="grid grid-cols-3 gap-6">
      ...
      <div class="col-span-3 sm:col-span-2">
        ...
        <input type="text" name="page[meta_keyword]" id="page[meta_keyword]" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" placeholder="shoes, shirt, t-shirt, ..." required>
      </div>
