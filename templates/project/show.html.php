    ...
    <div class="max-w-3xl mx-auto px-4 sm:px-6 md:flex md:items-center md:justify-between md:space-x-5 lg:max-w-7xl lg:px-8">
      <div class="flex items-center space-x-5">
        <div>
          ...
          <p class="text-sm font-medium text-gray-500">Created <time><?= Timex::from_now($GLOBALS["page"]["page_inserted_at"]) ?></time></p>
        </div>
      </div>
            ...
            <div class="px-4 py-5 sm:px-6 flex justify-between">
              <div>
                <h2 class="text-sm leading-6 font-semibold text-gray-900">
                  ...
                  <?php else : ?>
                    <input type="text" name="page[title]" placeholder="please fill title" class="px-2 py-0.5 w-full text-md border-b border-gray-300">
                  <?php endif ?>
                </h2>
            ...
            <div class="border-t border-gray-200 px-4 py-5 sm:px-6">
              <div class="grid grid-cols-4 pb-5 gap-4">
                ...
                <div class="col-span-3 p-4 bg-gray-100">
                  ...
                  <img class="rounded-sm ml-auto w-full h-full" src="<?= Utils::default_image($img, "520x280") ?>" alt="<?= $GLOBALS['page']["attachment_name"] ?>">
                </div>
              </div>
            </div>
                ...
                <div class="relative flex space-x-3">
                  ...
                  <div>
                    <p class="text-sm text-gray-500">ID :
                      <span class="font-medium text-gray-900"><?= $GLOBALS["page"]["page_id"] ?></span>
                    </p>
                    <p class="text-sm text-gray-500">URL :
                      <span class="font-medium text-gray-900 hover:text-indigo-600">
                        <a href="mailto:<?= $GLOBALS["page"]["user_email"] ?>"><?= $GLOBALS["page"]["user_email"] ?></a>
                      </span>
                    </p>
                    <p class="text-sm text-gray-500">Created at :
                      <span class="font-medium text-gray-900"><time><?= $GLOBALS["page"]["page_inserted_at"] ?></time></span>
                    </p>
                  </div>
                </div>
              </li>
                ...
                <div class="relative flex space-x-3">
                  ...
                  <div>
                    <p class="text-sm text-gray-500">Name :
                      <span class="font-medium text-gray-900 capitalize"><?= $GLOBALS["page"]["user_name"] ?></span>
                    </p>
