...
<?php if (!empty($GLOBALS['num_next_page']) && !empty($GLOBALS['num_current_page']) && !empty($GLOBALS['total_of_page']) && ($GLOBALS['num_next_page'] - $GLOBALS['num_current_page']) < $GLOBALS['total_of_page']) : ?>
